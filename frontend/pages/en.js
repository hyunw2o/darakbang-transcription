...
function ThemeToggle({ darkMode, setDarkMode }) {
  return (
    <button
      ...
      className="nm-btn p-2.5 rounded-xl"
    ...
    <div className="min-h-screen pb-12">
        ...
        <div className="max-w-2xl mx-auto px-4 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <nav className="nm-segment-group">
              <Link
                href="/"
                className="nm-segment-item px-2.5 py-1 text-[11px] font-semibold"
              >
                KR
              </Link>
              <Link
                href="/en"
                className="nm-segment-item active px-2.5 py-1 text-[11px] font-semibold"
              >
                EN
              </Link>
            </nav>
      ...
      <main className="max-w-2xl mx-auto px-4 pt-6">
        <div className="nm-raised p-2.5 mb-4 animate-nm-card-in flex items-center justify-between gap-3">
          <p className="text-[11px] font-medium text-nm-text-secondary">Auto: Light Aurora / Dark Noir</p>
          ...
          {!authToken ? (
            <>
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-sm font-bold text-nm-text-primary">Account Access</h2>
                <div className="nm-segment-group">
                  <button
                    type="button"
              ...
              <div className="mt-4">
                <div className="relative mb-3">
                  <div className="absolute inset-0 flex items-center">
                    <div className="w-full border-t border-nm-text-secondary/20" />
                  </div>
                  <div className="relative flex justify-center">
                    <span className="px-2 text-[11px] text-nm-text-secondary bg-nm-bg">Or continue with social sign-in</span>
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-2">
                  {socialProviders.map((provider) => (
                    <button
                      ...
                      className="nm-btn w-full h-11 text-sm font-semibold text-nm-text-primary disabled:opacity-50"
                    >
        ...
        {!authToken && (
          <div className="nm-raised mb-5 p-5 text-center animate-nm-card-in">
            <h3 className="text-sm font-semibold text-nm-text-primary">Sign-in required</h3>
