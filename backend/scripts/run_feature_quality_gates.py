...
def run_special_term_sample() -> None:
    ...
    run_command([
        ...
        (
            "import sys; "
            "sys.path.insert(0, 'backend'); "
            "from main import _build_transcription_progress, _build_transcription_status_response, _extract_transcription_logprob_stats, _is_low_confidence_transcription, _join_whisper_chunk_results; "
