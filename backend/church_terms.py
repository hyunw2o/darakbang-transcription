...
6. 발음이 부정확하거나 음성인식이 이상해도, 반드시 문맥에 맞는 올바른 단어로 교정하여 기록하라.
   ...
   - 혼동어는 기계적으로 치환하지 말고 문맥으로 구분하라:
     결재/결제(승인 vs 지불), 낫다/낳다/낮다(회복 vs 출산 vs 높이 반대), 안/않(부정 부사 vs 용언 부정), 되/돼(되어의 축약), 웬/왠(어찌 된 vs 왜인지), 3오늘/삼오늘/세오늘/사모늘(숫자 표기 우선), 포럼방/포럼망
...
3. '올해/오래', '결재/결제', '낫다/낳다/낮다', '안/않', '되/돼', '웬/왠(특히 왠지)', '3오늘/삼오늘(세오늘/사모늘)', '포럼방/포럼망'은 반드시 문맥으로 구분하라.
...
- 음성인식 오류를 문맥에 맞게 교정하라:
  ...
  올해/오래, 결재/결제, 낫다/낳다/낮다, 안/않, 되/돼, 웬/왠(특히 왠지), 3오늘/삼오늘/세오늘/사모늘, 포럼방/포럼망은 기계적으로 치환하지 말고 문맥으로 구분
  (연도/시점=올해, 기간/오랜 시간=오래 / 승인=결재, 지불=결제 / 회복=낫다, 출산=낳다, 높이 반대=낮다 / 숫자 의미면 3오늘 / 모임 공간 의미면 포럼방)
...
- 음성인식 오류를 문맥에 맞게 교정하라.
- 혼동어는 반드시 문맥으로 구분하라:
  올해/오래, 결재/결제, 낫다/낳다/낮다, 안/않, 되/돼, 웬/왠(특히 왠지), 3오늘/삼오늘(세오늘/사모늘), 포럼방/포럼망
