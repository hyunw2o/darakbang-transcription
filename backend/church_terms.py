...
3. '올해/오래', '결재/결제', '낫다/낳다/낮다', '안/않', '되/돼', '웬/왠(특히 왠지)', '3오늘/삼오늘(세오늘/사모늘)', '포럼방/포럼망', '알리/REA', '수련의/수련회', '노회/노예', '유초등부/유초동부', '교역자/교육자', '부교역자/부교육자', '신방/심방', '쉬고와/기도', '대위/대희', '임마누엘/임만', '죄책감/최책감', '네피림/레피림', 'RBS/RVS', '디모데/D 모델', 'CDE/CD(Common Data Elements)'은 반드시 문맥으로 구분하라.
...
- 음성인식 오류를 문맥에 맞게 교정하라:
  ...
  올해/오래, 결재/결제, 낫다/낳다/낮다, 안/않, 되/돼, 웬/왠(특히 왠지), 3오늘/삼오늘/세오늘/사모늘, 포럼방/포럼망, 알리/REA, 수련의/수련회, 노회/노예, 유초등부/유초동부, 교역자/교육자, 부교역자/부교육자, 신방/심방, 쉬고와/기도, 대위/대희, 임마누엘/임만, 죄책감/최책감, 네피림/레피림, RBS/RVS, 디모데/D 모델, CDE/CD(Common Data Elements)는 기계적으로 치환하지 말고 문맥으로 구분
  (연도/시점=올해, 기간/오랜 시간=오래 / 승인=결재, 지불=결제 / 회복=낫다, 출산=낳다, 높이 반대=낮다 / 숫자 의미면 3오늘 / 모임 공간 의미면 포럼방 / '알리'는 인명·브랜드·일반 고유명사면 유지, 선교 약어를 철자로 말한 맥락일 때만 REA / 의료 인력 맥락=수련의, 교회 집회 맥락=수련회 / 교단 회의 맥락=노회 / 교회 부서 맥락=유초등부 / 목회·사역 맥락=교역자·부교역자 / 학교·수업 맥락=교육자·부교육자 / 교회 방문 사역 맥락=심방 / 예배 마무리·기도 안내 맥락=기도 / 의료정보 표준 맥락=CD 대신 CDE(Common Data Elements))
...
- 의료: 진단, 처방, 약물명, 검사명, 부작용, CDE(Common Data Elements)
...
- 음성인식 오류를 문맥에 맞게 교정하라.
- 혼동어는 반드시 문맥으로 구분하라:
  올해/오래, 결재/결제, 낫다/낳다/낮다, 안/않, 되/돼, 웬/왠(특히 왠지), 3오늘/삼오늘(세오늘/사모늘), 포럼방/포럼망, 알리/REA, 수련의/수련회, 노회/노예, 유초등부/유초동부, 교역자/교육자, 부교역자/부교육자, 신방/심방, 쉬고와/기도, 대위/대희, 임마누엘/임만, 죄책감/최책감, 네피림/레피림, RBS/RVS, 디모데/D 모델, CDE/CD(Common Data Elements)
...
- 의료/헬스케어: 진단, 처방, 임상, 프로토콜, CT, MRI, 부작용, 추적관찰, CDE(Common Data Elements)
