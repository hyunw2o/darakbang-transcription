...
DARAKBANG_CORE = [
    ...
    # 행사/모임
    "성회", "전도대회", "수련회", "전도집회", "집회", "세미나", "기도수첩", "포럼방", "포럼 방",
...
3. '올해/오래', '결재/결제', '낫다/낳다/낮다', '안/않', '되/돼', '웬/왠(특히 왠지)', '3오늘/삼오늘(세오늘/사모늘)', '포럼방/포럼망', '알리/REA', '수련의/수련회', '노회/노예', '유초등부/유초동부', '교역자/교육자', '부교역자/부교육자', '신방/심방', '쉬고와/기도'는 반드시 문맥으로 구분하라.
...
- 음성인식 오류를 문맥에 맞게 교정하라:
  ...
  올해/오래, 결재/결제, 낫다/낳다/낮다, 안/않, 되/돼, 웬/왠(특히 왠지), 3오늘/삼오늘/세오늘/사모늘, 포럼방/포럼망, 알리/REA, 수련의/수련회, 노회/노예, 유초등부/유초동부, 교역자/교육자, 부교역자/부교육자, 신방/심방, 쉬고와/기도는 기계적으로 치환하지 말고 문맥으로 구분
...
- 음성인식 오류를 문맥에 맞게 교정하라.
- 혼동어는 반드시 문맥으로 구분하라:
  올해/오래, 결재/결제, 낫다/낳다/낮다, 안/않, 되/돼, 웬/왠(특히 왠지), 3오늘/삼오늘(세오늘/사모늘), 포럼방/포럼망, 알리/REA, 수련의/수련회, 노회/노예, 유초등부/유초동부, 교역자/교육자, 부교역자/부교육자, 신방/심방, 쉬고와/기도
...
def _normalize_contextual_homophones(text: str) -> str:
    ...
    ministry_context = (
        r"(교회|목회|설교|예배|사역|전도|선교|강단|담임|목사|부목사|전도사|장로|권사|집사|청빙|안수|교구|심방|성도|새가족|주일학교|청년부|학생부|부서)"
    )
    education_context = (
