...
KO_DOMAIN_CONTEXT_TERMS = (
    ...
    "의료(진단, 처방, 약물, CT, MRI, 부작용, CDE(Common Data Elements), CD와 문맥 구분), "
    "인문학(철학, 윤리, 문해력, 서사, 해석), "
    "교육(교육과정, 평가, 학습목표, 피드백), "
    ...
    if language == "en":
        ...
        if transcription_type == "sermon":
            ...
            whisper_prompt = (
                ...
                "'올해/오래, 결재/결제, 낫다/낳다/낮다, 안/않, 되/돼, 웬/왠(특히 왠지), 수련의/수련회, 노회/노예, 유초등부/유초동부, 교역자/교육자, 부교역자/부교육자, 신방/심방, 쉬고와/기도, RBS/RVS, 디모데/D 모델, CDE/CD(Common Data Elements)'은 문맥으로 구분하세요. "
            ...
            whisper_prompt = (
                ...
                "'올해/오래, 결재/결제, 낫다/낳다/낮다, 안/않, 되/돼, 웬/왠(특히 왠지), 수련의/수련회, 노회/노예, 유초등부/유초동부, 교역자/교육자, 부교역자/부교육자, 신방/심방, 쉬고와/기도, CDE/CD(Common Data Elements)'는 문맥으로 구분하세요. "
                "고혈압, 당뇨병, 심근경색, 갑상선, 위염, 폐렴, 천식, 관절염, 디스크, 우울증, 불면증, "
                "뇌전증, 간질, 발작, 항경련제, 레비티라세탐, 카바마제핀, 발프로산, 라모트리진, "
                "타이레놀, 아세트아미노펜, 이부프로펜, 메트포르민, 아목시실린, 오메프라졸, 인슐린, "
                "혈압, 혈당, CT, MRI, EEG, 내시경, 혈액검사, 심전도, 처방, 복용, 부작용, 합병증, 앉은뱅이, "
