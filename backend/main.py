    ...
    if language == "en":
        ...
        if transcription_type == "sermon":
            ...
            whisper_prompt = (
                ...
                "'올해/오래, 결재/결제, 낫다/낳다/낮다, 안/않, 되/돼, 웬/왠(특히 왠지), 수련의/수련회, 노회/노예, 유초등부/유초동부, 교역자/교육자, 부교역자/부교육자, 신방/심방, 쉬고와/기도, RBS/RVS, 디모데/D 모델'은 문맥으로 구분하세요. "
