...
const I18N = {
  ko: {
    ...
    glossaryTermPlaceholder: "정확한 표기 (예: RVS)",
    glossaryMeaningPlaceholder: "뜻/설명 (예: Remnant Vision School)",
    glossaryAliasesPlaceholder: "오인식/별칭 (쉼표 또는 줄바꿈)",
    glossaryContextsPlaceholder: "문맥 힌트 (예: 비전스쿨, 드로아교회)",
    glossaryAdd: "용어 추가",
  ...
  en: {
    ...
    glossaryTermPlaceholder: "Preferred spelling (e.g. RVS)",
    glossaryMeaningPlaceholder: "Meaning/description (e.g. Remnant Vision School)",
    glossaryAliasesPlaceholder: "Misrecognitions or aliases (comma or newline)",
    glossaryContextsPlaceholder: "Context hints (e.g. vision school, church name)",
