...
const I18N = {
  ko: {
    ...
    deleteAll: "전체 삭제",
    active: "진행 중",
    historyDeleteConfirmTitle: "기록 삭제",
    historyDeleteConfirmMessage: "이 변환 기록을 삭제할까요?",
    historyDeleteAllConfirmTitle: "전체 기록 삭제",
    historyDeleteAllConfirmMessage: "이 계정의 변환 기록을 모두 삭제할까요? 진행 중인 작업은 유지됩니다.",
    selectedTypeHints: {
  ...
  en: {
    ...
    active: "Active",
    historyDeleteConfirmTitle: "Delete history",
    historyDeleteConfirmMessage: "Delete this transcription history item?",
    historyDeleteAllConfirmTitle: "Delete all history",
    historyDeleteAllConfirmMessage: "Delete all transcription history for this account? Active tasks will be kept.",
    selectedTypeHints: {
