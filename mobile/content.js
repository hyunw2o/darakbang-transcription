...
const I18N = {
  ko: {
    ...
    iosFreeOnlyNotice: "iOS 버전은 현재 무료 플랜으로 제공됩니다. 앱 내 Pro 구독은 Apple 인앱결제 승인 후 제공될 예정입니다.",
    ...
    appleIapProductUnavailableTitle: "App Store 상품을 찾을 수 없습니다",
    appleIapProductTimeout: "App Store 상품 조회가 지연되고 있습니다. 네트워크 상태를 확인한 뒤 다시 시도해 주세요.",
    ...
    appleIapUnavailable: "App Store 구독 상품을 아직 불러오지 못했습니다. App Store Connect 상품 ID, 상품 상태, 앱 버전 연결 여부를 확인해 주세요.",
    appleIapConnected: "App Store 연결됨",
    appleIapDisconnected: "App Store 연결 대기",
  ...
  en: {
    ...
    iosFreeOnlyNotice: "The iOS version is currently offered as a free plan. In-app Pro subscription will be available after Apple In-App Purchase approval.",
    ...
    appleIapProductUnavailableTitle: "App Store product not found",
    appleIapProductTimeout: "Loading the App Store product is taking longer than expected. Check the network and try again.",
    ...
    appleIapUnavailable: "The App Store subscription product is not available yet. Check the App Store Connect product ID, product status, and app version attachment.",
    appleIapConnected: "App Store connected",
    appleIapDisconnected: "Waiting for App Store",
