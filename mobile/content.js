...
const I18N = {
  ko: {
    ...
    processingSteps: {
      ...
      jobReady: "작업 준비와 용어집 확인",
      audioPrepared: "오디오 형식과 길이 점검",
      silenceSplit: "문장 사이 무음 기준 분할",
      timelineChecked: "전체 시간축 누락 검사",
      recognized: "청크 병렬 음성 인식",
      confidenceReviewed: "저신뢰 구간 검토와 재인식",
      timestampMerged: "타임스탬프 기반 병합",
      structured: "텍스트 교정과 구조화",
      saved: "최종 결과 저장",
    },
    processingDetails: {
    ...
    errors: {
      ...
      statusRetrying: "네트워크가 불안정하지만 서버의 변환 작업은 계속됩니다. 연결을 다시 확인하고 있습니다.",
  ...
  en: {
    ...
    processingSteps: {
      ...
      jobReady: "Prepare job and glossary",
      audioPrepared: "Check audio format and duration",
      silenceSplit: "Split at natural silence",
      timelineChecked: "Verify full timeline coverage",
      recognized: "Parallel speech recognition",
      confidenceReviewed: "Review and retry uncertain audio",
      timestampMerged: "Timestamp-based merge",
      structured: "Refine and structure text",
      saved: "Save final result",
    },
    processingDetails: {
      uploading: "Uploading the audio file securely.",
      queued: "Upload complete. Waiting for a transcription worker.",
      loading_glossary: "Loading your glossary and speech recognition hints.",
      preparing_audio: "Checking the audio format and full duration.",
      detecting_silence: "Finding natural silence between sentences.",
      splitting_audio: "Splitting the full timeline at sentence boundaries.",
      validating_coverage: "Verifying that every moment of the source audio is covered.",
      transcribing: "Recognizing multiple audio chunks in parallel.",
      reviewing_confidence: "Checking low-confidence words and cut sentence boundaries.",
      retranscribing: "Re-recognizing uncertain audio with prior context and glossary terms.",
    ...
    errors: {
      ...
      statusRetrying: "The connection is unstable, but the server job is still running. Reconnecting to check its status.",
