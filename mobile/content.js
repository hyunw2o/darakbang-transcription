...
const I18N = {
  ko: {
    ...
    appleIapUnavailable: "App Store 구독 상품을 아직 불러오지 못했습니다. App Store Connect 상품 ID를 확인해 주세요.",
  ...
  en: {
    ...
    appleIapUnavailable: "The App Store subscription product is not available yet. Check the App Store Connect product ID.",
