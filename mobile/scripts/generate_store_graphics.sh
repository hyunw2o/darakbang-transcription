...
ffmpeg -y \
  -f lavfi -i "color=c=#0f1728:s=1080x1920:d=1" \
  -i "$ICON_PATH" \
  -filter_complex "[0:v]drawbox=x=0:y=0:w=1080:h=1920:color=#0f1728:t=fill,drawbox=x=0:y=0:w=1080:h=580:color=#17315a@0.62:t=fill,drawbox=x=56:y=620:w=968:h=1220:color=#101f38@0.88:t=fill,drawbox=x=96:y=760:w=888:h=190:color=#1c3966@0.95:t=fill,drawbox=x=96:y=980:w=888:h=22:color=#122745@0.95:t=fill,drawbox=x=96:y=980:w=612:h=22:color=#3b78d1@0.98:t=fill,drawbox=x=96:y=1040:w=888:h=90:color=#2a5ca1@0.96:t=fill,drawbox=x=96:y=1160:w=888:h=90:color=#1f3f6e@0.96:t=fill,drawbox=x=96:y=1290:w=888:h=90:color=#1a365f@0.96:t=fill,drawtext=fontfile=${FONT_PATH}:text='사용량 · 구독 관리':fontsize=72:fontcolor=white:x=72:y=172,drawtext=fontfile=${FONT_PATH}:text='남은 시간 확인과 업그레이드':fontsize=40:fontcolor=#c6d5f3:x=74:y=278,drawtext=fontfile=${FONT_PATH}:text='월간 사용량을 투명하게 관리하세요':fontsize=34:fontcolor=#d6e2fb:x=74:y=340,drawtext=fontfile=${FONT_PATH}:text='이번 달 사용량: 6h 20m / 10h':fontsize=36:fontcolor=white:x=130:y=825,drawtext=fontfile=${FONT_PATH}:text='사용량 새로고침':fontsize=30:fontcolor=white:x=178:y=1100,drawtext=fontfile=${FONT_PATH}:text='구독 업그레이드':fontsize=30:fontcolor=white:x=178:y=1220,drawtext=fontfile=${FONT_PATH}:text='구독 관리':fontsize=30:fontcolor=white:x=178:y=1350,drawtext=fontfile=${FONT_PATH}:text='mallog24':fontsize=30:fontcolor=#c6d5f3:x=840:y=1848[bg];[1:v]scale=112:112[icon];[bg][icon]overlay=856:70" \
  -frames:v 1 \
  -update 1 \
  "$OUT_DIR/screenshot-05-usage-subscription-1080x1920.png"
